...
<link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/custom.css">
   ...
   <link rel="stylesheet" href="<?php echo base_url();?>/assets/css/ckeditor.css">
	...
	<?php //} if ($page == 'transport-master' || $page == 'vehicle_master' || $page == 'diesel_master' || $page == 'zone_master' || $page == 'invoice_paid' || $page == 'invoice_overdue' || $page == 'invoice_draft' || $page == 'invoice_recurring' || $page == 'invoice_cancelled' || $page == 'invoice_item' || $page == 'invoice_category' || $page == 'payments' || $page == 'expenses' || $page == 'sales_report' || $page == 'expenses_report' || $page == 'profit_loss_report' || $page == 'taxs_report' || $page == 'users' || $page == 'data_tables' || $page == 'invoice_grid_two') { ?>

                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="date-picker">
                                ...
                                <div class="form-custom cal-icon">
                                    ...
                                    <input class="form-control datetimepicker" type="text" name="end_date" placeholder="End Date" value="<?php echo isset($end_date) ? $end_date : date('Y-m-d'); ?>">
                    ...
                    <div class="card card-table"> 
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-scroll" >
                                ...
                                <table id="<?php echo ($report != 'detention')? '' : $report ?>" class="table" style="font-size: 14px;table-layout: auto;">
                                ...
                                <table id="<?php echo ($report != 'cost')? '' : $report ?>" class="table" style="font-size: 14px; table-layout: auto;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <?php echo ($cost['TOTAL_VAL'])? number_format($cost['TOTAL_VAL']) :  number_format($cost['Rate']); ?>
                                            </td>
                                            ...
                                            <?php  $unbill=(($cost['TOTAL_VAL'])? ($cost['TOTAL_VAL'] ):  $cost['Rate']) + $cost['DETENTION'] + $cost['OTHCHRGS']; echo  number_format($unbill); ?> </td>

                                            <td>

                                            <?php echo ($cost['STATUS']=='K')? 0 : number_format($unbill) ; ?></td>
                    ...
                    <div class="NewHorizontalTable">
	                    <table style="width: 70%;">
						    <tr>
						        ...
						        <td><?php $TotBilledAmt = round($TotalBillingAmount)-round($TotalUnbilledAmount); echo number_format($TotBilledAmt); ?></td>
                            ...
                            <div class="table-scroll">
                                ...
                                <table id="<?php echo ($report != 'transport')? '' : $report ?>" class="table table-striped table-hover datatable table-bordered" style="font-size: 14px;">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $unbill= number_format($gtrans['TOTAL_Val'] + $gtrans['DETENTION'] + $gtrans['OTHCHRGS']); ?></td>
                    ...
                    <div class="card card-table w-auto"> 
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-scroll">
                                ...
                                <table id="<?php echo ($report != 'Customer')? '' : $report ?>" class="table table-striped table-hover datatable table-bordered" style="font-size: 14px;">
                    ...
                    <div class="card card-table w-auto"> 
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-scroll">
                                ...
                                <table id="<?php echo ($report != 'CostvsRecovery')? '' : $report ?>" class="table table-striped table-hover datatable table-bordered" style="font-size: 14px;">
                ...
                <div id="" class="<?php echo ($report != 'BudgetvsActual')? 'd-none' : '' ?> reports">
                    ...
                    <div class="card card-table" style="width:100% !important;"> 
                        ...
                        <div class="table-scroll">
                                ...
                                <table id="<?php echo ($report != 'BudgetvsActual')? '' : $report ?>" class="table table-striped table-hover datatable table-bordered" style="font-size: 14px;">
...
<?php echo $BudgetvsActual['LR_No']; ?></td>
                                            ...
                                            <td>
                                                ...
                                                <?php $BudgetvsActual['CONS_SIZE']= ($BudgetvsActual['CONS_SIZE'])? $BudgetvsActual['CONS_SIZE'] : 1; echo number_format($Budget_freight = round(($BudgetvsActual['FRT_PER_C']/$BudgetvsActual['CONS_SIZE']) * $BudgetvsActual['monthval'])); ?> </td>
                                            ...
                                            <td>
                                                ...
                                                <?php echo number_format(($BudgetvsActual['monthdata'] - str_replace(',', '', $BudgetvsActual['BILL_QTY'])));  ?> </td>
                                            <td>
                    ...
                    ?>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-scroll">
                                ...
                                <table id="<?php echo ($report != 'dieselCost')? '' : $report ?>" class="table table-striped table-hover datatable table-bordered" style="font-size: 14px;">
                                ...
                                <table id="<?php echo ($report != 'dieselWithFreight')? '' : $report ?>" class="table table-striped table-hover datatable table-bordered" style="font-size: 14px; overflow-x:auto;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <?php echo ($dieselCostwithfreight['TOTAL_VAL'])? number_format($dieselCostwithfreight['DETENTION'] + $dieselCostwithfreight['OTHCHRGS']+ ($dieselCostwithfreight['TOTAL_VAL'])) : number_format($dieselCostwithfreight['DETENTION'] + $dieselCostwithfreight['OTHCHRGS']+ ($dieselCostwithfreight['Rate'])); ?></td>
                    ...
                    <div class="card card-table"> 
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-scroll">
                                ...
                                <table id="<?php echo ($report != 'vehicleUtilization')? '' : $report ?>" class="table table-striped table-hover datatable table-bordered" style="font-size: 14px;">
                    ...
                    <div class="card card-table"> 
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-scroll">
                                ...
                                <table id="<?php echo ($report != 'freight')? '' : $report ?>" class="table table-striped table-hover datatable table-bordered" style="font-size: 14px;">

                ...
                <ul class="nav nav-tabs user-menu">
                    ...
                    <li class="nav-item dropdown has-arrow flag-nav">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a href="javascript:void(0);" class="dropdown-item"> Change Register </a>
                            ...
                            <a href="javascript:void(0);" class="dropdown-item"> Transporter Invoices </a>
                            <a href="javascript:void(0);" class="dropdown-item"> Transporter Credentials </a>
                            <a href="javascript:void(0);" class="dropdown-item"> Delete Lr </a>
                        </div>
                    </li>
                    <!-- /Flag -->
                    ...
                    <li class="nav-item dropdown has-arrow main-drop">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="index"><i data-feather="log-out" class="me-1"></i> Logout</a>
                        </div>
                    </li>
                    <!-- /User Menu -->
